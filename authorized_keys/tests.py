...
testdata = [{
		...
		"keytype": "ssh-rsa",
		"fingerprint": "d4:3c:c8:39:f7:c3:cc:1e:99:d6:f9:c8:c4:13:14:e1",
		"comment": "sheep@pasture",
		"sha256fp": "SHA256:lxfaWMqFWQKTdN32cT7saRHsGCYtahwHqtdWjEPVgG0 sheep@pasture",
	}]
...
class PubSSHKeyTests(TestCase):
	...
	def test_valid_creation(self):
		for data in testdata:
			...
			self.assertEqual(pubkey.fingerprint, data["fingerprint"])
